<div class="flex items-center my-5 px-4 bg-white">
    ...
    <div class="m-4">
        <a href="" style="display: flex; color: red;"><p style="margin-right: 4px; font-weight: bold; color: black">{{ $post->likes }}</p><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
